# Contributing to BuddyServers

We appreciate your interest in contributing to BuddyServers! To maintain quality, consistency, and clarity in the development process, please review and adhere to the following guidelines before submitting a pull request.
...
BuddyServers is built to run on Windows, macOS, and Linux. Thorough testing is crucial to maintaining the stability of the software across all platforms.
...
### Telepath Testing
If your contribution affects [Telepath](https://www.BuddyServers.com/guides/telepath), please test both server modes:
...
Thanks for helping to make BuddyServers better! Feel free to reach out on our [Discord](https://discord.gg/dShCFbgNYJ) with any questions.
