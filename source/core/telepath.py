...
# BuddyServers Telepath API
# This library abstracts BuddyServers functionality to control servers remotely
# ----------------------------------------------- Global Variables -----------------------------------------------------
...
def create_schema():
    ...
    openapi_schema = get_openapi(
        title="BuddyServers - Telepath API",
        version=TelepathManager.version,
        summary="Welcome to the BuddyServers Telepath API! You can use this utility for seamless remote management.",
        routes=app.routes,
    )
