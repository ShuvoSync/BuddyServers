...
class ScriptWebObject():
    def __init__(self, data: tuple or list):
        ...
        for name, url in data.items():
            ...
            elif name.endswith(".ams") or name.endswith(".bs"):
                self.file_name = name
...
class ScriptFileObject():
    def __init__(self, path, enabled=False):
        ...
        self.title = self.file_name.replace(".ams", "").replace(".bs", "")
        self.author = None
        self.version = None
        self.description = None
...
class ScriptManager():
    ...
    def import_script(self, script: str):
        ...
        if source_dir != paths.scripts and (source_name.endswith(".ams") or source_name.endswith(".bs")):
...
class ScriptObject():
    ...
    def construct(self):
        ...
        self.scripts = [os.path.join(paths.executable_folder, 'core', 'server', 'baselib.bs')]
