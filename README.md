...
Some notable features include:
 ...
 BuddyServers completely supports, updates, and manages:
...
### Create a New Server
- For the vast majority of users, BuddyServers is preconfigured to provide optimal settings. Check out our instant server templates to start playing immediately!
...
### Import a Server
- BuddyServers can detect and manage a wide variety of servers that you have made yourself. Select the root folder of the server and click import to use all of BuddyServers's features!
...
As this is a relatively new project, a lot of things have and may change during development. [Visit the website for a comprehensive overview of all the features provided by BuddyServers](https://www.BuddyServers.com/guides).


<br><br>

# Contact & Inquiries
- If you experience a crash, please submit an issue with the bug label including the crash report provided by BuddyServers.
<br><br>
...
<br><br>
- For all other inquiries including security issues or suggestions, [please contact us directly via email](mailto:help@BuddyServers.com?subject=Inquiry%20-%20).
...
<br><br>
- By using this software you agree to the [terms & conditions](https://www.BuddyServers.com/terms-and-conditions)
